...
const Sign_Up = () => {
  return (
        <div class="container" styles="margin-top: 5%;"> 
        <div class="signup-grid"> 
            <div class="signup-text"> 
                <h1>Sign Up</h1>
            </div>
            <div class="signup-text1" styles="text-align: left;"> 
                Already a member? <span><a href="../Login" styles="color: #2190FF;"> Login</a></span>
            </div>
